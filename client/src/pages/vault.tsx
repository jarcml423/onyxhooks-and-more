...
import VaultForgeElite from "@/components/VaultForgeElite";
import VisualTemplateCard from "@/components/VisualTemplateCard";
import StarterTierDashboard from "@/components/StarterTierDashboard";
import PlatinumLotteryCard from "@/components/PlatinumLotteryCard";
  ...
  return (
    <VaultProtection>
      <div 
        ...
        style={{
          background: `
            linear-gradient(145deg, #0B0E1A 0%, #111827 50%, #1C84FF 100%),
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <motion.div
                ...
                style={{ background: "linear-gradient(135deg, #F9C80E 0%, #E6B800 100%)" }}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <Crown className="h-8 w-8" style={{ color: "#0B0E1A" }} />
              </motion.div>
              <div>
                <h1 className="text-4xl font-bold" style={{ color: "#F3F4F6" }}>
                  VaultForge Elite
                </h1>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <TabsContent value="workflow" className="space-y-6">
              <VaultForgeElite onComplete={() => {
                toast({
                  title: "Elite Campaign Generated",
                  description: "Your enterprise-level campaign is ready for deployment",
                });
              }} />
            </TabsContent>
