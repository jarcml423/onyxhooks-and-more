...
export default function Signup() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Then proceed with Firebase signup
      await signupWithEmail(email, password);
      toast({
        title: "Welcome to OnyxHooks & More™!",
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join 2,000+ creators mastering high-converting hooks with AI
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4">
              ...
              {/* Security verification - domain configuration needed for production */}
              <div className="flex justify-center">
                <div className="text-center text-sm text-amber-600 bg-amber-50 p-3 rounded border border-amber-200 w-full">
                  <p className="font-medium">🟨 Security verification ready</p>
                  <p className="text-xs mt-1">Anti-bot protection active. Additional verification will be enabled in production.</p>
                </div>
              </div>
